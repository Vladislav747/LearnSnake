var Snake = (function () {
  ...
  //Статистика игры очки и так далее
  var reward = 0;
  var points = 0;
  var pointsMax = 0;

  var ActionEnum = { none: 0, up: 1, down: 2, left: 3, right: 4 };
  //Заморозка обхекта - Разморозить можно только клонированием
  Object.freeze(ActionEnum);
  var lastAction = ActionEnum.none;

  //Сброс предыдущего поля игры
  function setup() {
  ...
  //Движение змейки с помощью клавиш
